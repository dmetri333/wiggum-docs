...
<html lang="en-US">
	<head>
		...
		<title>Services | Wiggum a php framework</title>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7">
					...
					<section>	
						<p>Wiggum uses dependency containers Services get attach to Controllers as properties, all services are dependency container. Wiggum uses a dependency container to prepare, manage, and inject application dependencies. </p>
